...
public class ElasticSearchServiceImpl implements ElasticSearchService {
	...
	public String createNote(NoteModel userNote) {
		...
		IndexRequest indexRequest = new IndexRequest(INDEX, TYPE, String.valueOf(userNote.getId())).source(Mapper);
	...
	public String updateNote(NoteModel note) {
		...
		UpdateRequest updateRequest = new UpdateRequest(INDEX, TYPE, String.valueOf(note.getId())).doc(mapper);
		try {
